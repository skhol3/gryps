...
| 2 | OCR backend contract, PaddleOCR adapter, and `PLATE_READ` wiring | PR 2 | Base = PR 1 branch; keep fake-backed functional OCR tests in this slice; optional dependency/lockfile changes were split and merged in PR #23 |
...
- [x] 1.3 Add optional `paddleocr` extra to `pyproject.toml` without making it a default install dependency. Completed by merged dependency PR #23.
